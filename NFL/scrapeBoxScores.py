...
divisions = ['http://espn.go.com/nfl/scoreboard/_/year/2015/seasontype/2/week/' + week_num]
...
for division in divisions:
    ...
    if(len(halftime_ids) == 0):
        ...
        for i in range(0, len(halftime_ids)):
            ...
            time.sleep(x)
            espn1 = 'http://espn.go.com/nfl/game?gameId=' + halftime_ids[i]
            ...
            time.sleep(x)
            espn = 'http://espn.go.com/nfl/matchup?gameId=' + halftime_ids[i]
