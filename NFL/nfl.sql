...
CREATE TABLE NFLSBLines (  away_team CHAR(40) NOT NULL,
...
CREATE TABLE NFLSBHalfLines (away_team CHAR(40) NOT NULL,
        home_team CHAR(40) NOT NULL,
        line CHAR(10) NOT NULL,
        spread CHAR(10) NOT NULL,
        game_date TEXT NOT NULL,
...
CREATE TABLE NFLSBTeamLookup (sb_team CHAR(50) NOT NULL, espn_abbr CHAR(5), PRIMARY KEY (sb_team));
